...
This project is an MCP (Model Context Protocol) Server for the given OpenAPI URL - https://api.apis.guru/v2/specs/amazonaws.com/ecr/2015-09-21/openapi.json, auto-generated using AG2's [MCP builder](https://mcp.ag2.ai).
